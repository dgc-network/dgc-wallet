<?php
/**
 * dgc Payment for WooCommerce settings API helper class
 *
 * @version 1.0.0
 *
 * @author dgc.network
 */
if ( ! class_exists( 'dgc_Payment_Settings_API' ) ):

    class dgc_Payment_Settings_API {
                ...
                <?php foreach ( $this->settings_sections as $form ) { ?>
                    <div id="<?php echo $form['id']; ?>" class="group" style="display: none;">
                        <form method="post" action="options.php">
                            <?php
                            do_action( 'dgc_payment_form_top_' . $form['id'], $form );
                            settings_fields( $form['id'] );
                            do_settings_sections( $form['id'] );
                            do_action( 'dgc_payment_form_bottom_' . $form['id'], $form );
