...
class dgc_Wallet_REST_Controller extends WP_REST_Controller {
    ...
    public function get_items_permissions_check( $request ) {
        return apply_filters( 'dgc_wallet_rest_check_permissions', current_user_can( 'manage_woocommerce' ), 'read', $request );
    }
    ...
    public function create_item_permissions_check( $request ) {
        return apply_filters( 'dgc_wallet_rest_check_permissions', current_user_can( 'manage_woocommerce' ), 'create', $request );
    }
