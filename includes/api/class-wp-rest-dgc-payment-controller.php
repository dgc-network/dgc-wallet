...
class WP_REST_dgc_Payment_Controller extends WP_REST_Controller {
    ...
    public function get_item( $request ) {
        ...
        $balance = dgc_payment()->payment->get_payment_balance( $params['id'], 'edit' );
    ...
    public function create_item( $request ) {
        ...
        if ( isset( $params['type'] ) && isset( $params['amount'] ) ) {
            ...
            if ( 'credit' === $params['type'] ) {
                $transaction_id = dgc_payment()->payment->credit( $params['id'], $params['amount'], $params['details'] );
            } else if ( 'debit' === $params['type'] ) {
                $transaction_id = dgc_payment()->payment->debit( $params['id'], $params['amount'], $params['details'] );
            }
    ...
    public function get_items_permissions_check( $request ) {
        return apply_filters( 'dgc_payment_rest_check_permissions', current_user_can( 'manage_woocommerce' ), 'read', $request );
    }
    ...
    public function create_item_permissions_check( $request ) {
        return apply_filters( 'dgc_payment_rest_check_permissions', current_user_can( 'manage_woocommerce' ), 'create', $request );
    }
