...
/**
 * REST API dgc_Payment controller
 *
...
/**
 * REST API dgc_Payment controller class.
 *
 * @extends WC_REST_Controller
 */
class WC_REST_dgc_Payment_Controller extends WC_REST_Controller {
    ...
    public function get_items_permissions_check( $request ) {
        if ( ! apply_filters( 'dgc_payment_rest_check_permissions', current_user_can( 'manage_woocommerce' ), 'read', $request ) ) {
