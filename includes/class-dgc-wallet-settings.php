...
if ( ! class_exists( 'dgc_wallet_Settings' ) ):
    ...
    class dgc_wallet_Settings {
        ...
        public function admin_menu() {
            add_submenu_page( 'dgc-wallet', __( 'Settings', 'text-domain' ), __( 'Settings', 'text-domain' ), 'manage_woocommerce', 'dgc-wallet-settings', array( $this, 'plugin_page' ) );
        }
        ...
        public function get_settings_fields() {
            $settings_fields = array(
                ...
                '_wallet_settings_credit' => array_merge( 
                    array(
                        ...
                        array(
                            ...
                            'type' => 'select',
                            'options' => apply_filters( 'dgc_wallet_process_cashback_status', array( 'pending' => __( 'Pending payment', 'text-domain' ), 'on-hold' => __( 'On hold', 'text-domain' ), 'processing' => __( 'Processing', 'text-domain' ), 'completed' => __( 'Completed', 'text-domain' ) ) ),
                ...
                '_wallet_settings_conf' => array_merge( 
                    array(
                        array(
