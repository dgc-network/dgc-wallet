<?php
/**
 * dgc Wallet for WooCommerce settings API helper class
 *
 * @version 1.0.0
 *
 * @author dgc.network
...
if ( ! class_exists( 'dgc_Wallet_Settings_API' ) ):
    ...
    class dgc_Wallet_Settings_API {
        ...
        function callback_file( $args ) {
            ...
            $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'dgc-wallet' );
        ...
        function callback_attachment( $args ) {
            ...
            $id = $args['section'] . '[' . $args['id'] . ']';
            $label = isset( $args['options']['button_label'] ) ? $args['options']['button_label'] : __( 'Choose File', 'dgc-wallet' );
            $uploader_title = isset( $args['options']['uploader_title'] ) ? $args['options']['uploader_title'] : __( 'Select', 'dgc-wallet' );
            $uploader_button_text = isset( $args['options']['uploader_button_text'] ) ? $args['options']['uploader_button_text'] : __( 'Select', 'dgc-wallet' );
