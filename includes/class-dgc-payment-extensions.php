...
if ( ! class_exists( 'dgc_Payment_Extensions_Settings' ) ):
    ...
    class dgc_Payment_Extensions_Settings {
        ...
        public function admin_menu() {
            //add_submenu_page( 'dgc-payment', __( 'Extensions', 'dgc-payment' ), __( 'Extensions', 'dgc-payment' ), 'manage_woocommerce', 'dgc-payment-extensions', array( $this, 'plugin_page' ) );
        }
        ...
        public function admin_enqueue_scripts() {
            ...
            wp_register_script( 'dgc-payment-admin-settings', dgc_payment()->plugin_url() . '/assets/js/admin/admin-settings' . $suffix . '.js', array( 'jquery' ), DGC_WALLET_PLUGIN_VERSION);
        ...
        public function get_settings_sections() {
            $sections = array(
                array(
                    ...
                    'title' => __( 'Extensions', 'dgc-payment' ),
