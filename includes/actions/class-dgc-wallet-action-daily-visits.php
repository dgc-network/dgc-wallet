...
class Action_Daily_Visits extends dgc_WalletAction {

    public function __construct() {
        $this->id = 'daily_visits';
        $this->action_title = __( 'Daily visits', 'dgc-wallet' );
        $this->description  = __( 'Set credit for daily visits', 'dgc-wallet' );
    ...
    public function init_form_fields() {
        ...
        $this->form_fields = array(
            'enabled' => array(
                ...
                'type'    => 'checkbox',
                'label'   => __( 'Enable credit for daily visits.', 'dgc-wallet' ),
                'default' => 'no',
            ),
            'amount' => array(
            ...
            'exclude_role' => array(
                'title'       => __( 'Exclude user role', 'dgc-wallet' ),
                'description' => __( 'This option lets you limit which user role you want to exclude.', 'dgc-wallet' ),
                'type'        => 'multiselect',
            ...
            'description' => array(
                ...
                'default'     => __( 'Balance credited visiting site.', 'dgc-wallet' ),
                'desc_tip'    => true,
            )
        );
    }
    ...
    public function dgc_wallet_site_visit_credit() {
        ...
        if ( $this->settings['amount'] && apply_filters( 'dgc_wallet_site_visit_credit', true ) ) {
            dgc_wallet()->wallet->credit( $user_id, $this->settings['amount'], sanitize_textarea_field( $this->settings['description'] ) );
        }
    }
