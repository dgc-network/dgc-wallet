...
if ( ! class_exists( 'dgc_Payment_Ajax' ) ) {

    class dgc_Payment_Ajax {

        /**
         * The single instance of the class.
         *
         * @var dgc_Payment_Ajax
         * @since 1.1.10
         */
        ...
        public function __construct() {
            add_action( 'wp_ajax_dgc_payment_order_refund', array( $this, 'dgc_payment_order_refund' ) );
         ...
         */
        public function dgc_payment_refund_partial_payment(){
         ...
         * @throws Exception
         */
        public function dgc_payment_order_refund() {
            ob_start();
         ...
         * Search users
         */
        public function dgc_payment_user_search() {
            $return = array();
            if ( apply_filters( 'dgc_payment_user_search_exact_match', true ) ) {
                $user = get_user_by( apply_filters( 'dgc_payment_user_search_by', 'email' ), $_REQUEST['term'] );
        ...
        public function dgc_payment_partial_payment_update_session() {
