...
class dgc_wallet_Payment_Method extends WC_Payment_Gateway {
    ...
    public function init_form_fields() {
        $this->form_fields = array(
            ...
            'description' => array(
                ...
                'default' => __( 'Pay with dgcWallet.', 'text-domain' ),
                'desc_tip' => true,
            ),
            'instructions' => array(
    ...
    public function process_payment( $order_id ) {
        ...
        if ( $payment_response) {
            ...
            do_action( 'dgc_wallet_payment_processed', $order_id, $payment_response );
        }
