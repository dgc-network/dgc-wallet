...
if (!class_exists('dgc_Payment_Frontend')) {
    ...
    class dgc_Payment_Frontend {
        ...
        public function dgc_payment_styles() {
            ...
            //wp_register_script('wc-endpoint-payment', plugin_dir_url( __FILE__ ) . 'assets/js/frontend/wc-endpoint-payment' . $suffix . '.js', array('jquery', 'jquery-datatables-script'), DGC_PAYMENT_PLUGIN_VERSION);
