...
if ( ! class_exists( 'dgc_Wallet_Extensions_Settings' ) ):
    ...
    class dgc_Wallet_Extensions_Settings {
        ...
        public function __construct( $settings_api) {
            ...
            add_action( 'dgc_wallet_form_bottom__payment_settings_extensions_general', array( $this, 'display_extensions' ) );
        }
        ...
        public function admin_menu() {
            //add_submenu_page( 'dgc-wallet', __( 'Extensions', 'text-domain' ), __( 'Extensions', 'text-domain' ), 'manage_woocommerce', 'dgc-wallet-extensions', array( $this, 'plugin_page' ) );
        }
        ...
        public function admin_enqueue_scripts() {
            ...
            if (in_array( $screen_id, array( 'dgc_wallet_page_dgc-payment-extensions', 'dgc_wallet_page_dgc-payment-extensions' ) ) ) {
                        ...
                        <div class="addons-column-block">
                            ...
                            <div class="addons-column-block-item">
                                ...
                                <div class="addons-column-block-item-content">
                                    ...
                                    <a class="addons-button addons-button-solid" href="https://dgc.network/product/dgc_wallet-affiliatewp/">
                                        From: $15		</a>
