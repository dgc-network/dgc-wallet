    ...
    class dgc_Wallet_Extensions_Settings {
        ...
        public function admin_enqueue_scripts() {
            ...
            if (in_array( $screen_id, array( 'dgc_wallet_page_dgc-wallet-extensions', 'dgc_wallet_page_dgc-wallet-extensions' ) ) ) {
                ...
                wp_add_inline_style( 'dgc_wallet_admin_styles', 'tr.licence_key_nonce{ display:none; }' );
                wp_enqueue_media();
        ...
        public function get_settings_sections() {
            $sections = array(
                array(
                    ...
                    'title' => __( 'Extensions', 'dgc-wallet' ),
                    'icon' => 'dashicons-admin-plugins',
                )
            );
            return apply_filters( 'dgc_wallet_extensions_settings_sections', $sections);
        }
        ...
        public function get_settings_fields() {
            ...
            return apply_filters( 'dgc_wallet_extensions_settings_filds', $settings_fields);
        }
        ...
        public function display_extensions() {
            ...
            <div class="addons-featured">
                <div class="addons-banner-block">
                    <h1>Obtain Superpowers to get the best out of dgcWallet </h1>
                    <p>These power boosting extensions can unlock the ultimate potential for your site.</p>
                    <div class="addons-banner-block-items">
                        <div class="addons-banner-block-item">
                            <div class="addons-banner-block-item-icon">
                                <img class="addons-img" src="https://res.cloudinary.com/subrata91/image/upload/v1554208810/dgc_Wallet%20Extensions/Wallet-Withdrawl_01.jpg">
                            </div>
                            <div class="addons-banner-block-item-content">
                                ...
                                <a target="_blank" class="addons-button addons-button-solid" href="https://dgc.network/product/dgc-wallet-withdrawal/">
                                    From: $49		</a>
                            </div>
                        </div>
                        <div class="addons-banner-block-item">
                            <div class="addons-banner-block-item-icon">
                                <img class="addons-img" src="https://res.cloudinary.com/subrata91/image/upload/v1554208810/dgc_Wallet%20Extensions/Wallet-Importer_01.jpg">
                            </div>
                            <div class="addons-banner-block-item-content">
                                ...
                                <a target="_blank" class="addons-button addons-button-solid" href="https://dgc.network/product/dgc-wallet-importer/">
                                    From: $15		</a>
                            </div>
                        </div>
                        <div class="addons-banner-block-item">
                            <div class="addons-banner-block-item-icon">
                                <img class="addons-img" src="https://res.cloudinary.com/subrata91/image/upload/v1554208812/dgc_Wallet%20Extensions/dgcwallet-coupons.png">
                            </div>
                            <div class="addons-banner-block-item-content">
                                ...
                                <a target="_blank" class="addons-button addons-button-solid" href="https://dgc.network/product/dgc-wallet-coupons/">
                                    From: $39		</a>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="addons-column-block">
                            ...
                            <div class="addons-column-block-item">
                                ...
                                <div class="addons-column-block-item-content">
                                    ...
                                    <a class="addons-button addons-button-solid" href="https://dgc.network/product/dgcwallet-affiliatewp/">
                                        From: $15		</a>
