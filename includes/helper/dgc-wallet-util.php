...
if ( ! function_exists( 'is_wallet_rechargeable_order' ) ) {
    ...
    function is_wallet_rechargeable_order( $order ) {
        ...
        return apply_filters( 'dgc_wallet_is_wallet_rechargeable_order', $is_wallet_rechargeable_order, $order );
    }
...
if ( ! function_exists( 'is_wallet_rechargeable_cart' ) ) {
    ...
    function is_wallet_rechargeable_cart() {
        ...
        return apply_filters( 'dgc_wallet_is_wallet_rechargeable_cart', $is_wallet_rechargeable_cart);
    }
...
if ( ! function_exists( 'get_order_partial_payment_amount' ) ) {
    ...
    function get_order_partial_payment_amount( $order_id ) {
        ...
        return apply_filters('dgc_wallet_order_partial_payment_amount', abs( $via_wallet ), $order_id);
    }
...
if (!function_exists('dgc_wallet_persistent_cart_update')) {
    /**
     * Update dgc_Wallet persistent cart to restore cart after recharge wallet.
     */
