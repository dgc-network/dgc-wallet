...
function dgc_wallet_update_108_db_column() {
    global $wpdb;
    $table_name = $wpdb->base_prefix.'dgc_wallet_transactions';
...
function dgc_wallet_update_110_db_column() {
    global $wpdb;
    $table_name = $wpdb->base_prefix.'dgc_wallet_transactions';
...
function dgc_wallet_update_117_db_column() {
    global $wpdb;
    $table_name = $wpdb->base_prefix.'dgc_wallet_transactions';
...
function dgc_wallet_update_140_db_column() {
    global $wpdb;
    $table_name = $wpdb->base_prefix.'dgc_wallet_transactions';
