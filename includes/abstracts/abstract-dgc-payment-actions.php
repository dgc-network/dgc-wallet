...
abstract class dgc_PaymentAction extends WC_Settings_API {
    ...
    public function get_action_title() {
        return apply_filters( 'dgc_payment_gateway_action_title', $this->action_title, $this );
    }
    ...
    public function get_action_description() {
        return apply_filters( 'dgc_payment_action_description', $this->description, $this );
    }
