...
if (!class_exists('WCFMmp_Gateway_Woo_wallet') && class_exists('WCFMmp_Abstract_Gateway')) {
    ...
    class WCFMmp_Gateway_Woo_wallet extends WCFMmp_Abstract_Gateway {
        ...
        public function __construct() {
            ...
            $this->gateway_title = __('Wallet', 'dgc-wallet');
        ...
        public function process_payment($withdrawal_id, $vendor_id, $withdraw_amount, $withdraw_charges, $transaction_mode = 'auto') {
            ...
            if ($this->validate_request()) {
                $transaction_id = dgc_wallet()->wallet->credit($this->vendor_id, $this->withdraw_amount, __('Commission received for commission id #', 'dgc-wallet') . $this->withdrawal_id);
                ...
                return array('status' => true, 'message' => __('New transaction has been initiated', 'dgc-wallet'));
            } else {
                return $this->message;
            }
        }
