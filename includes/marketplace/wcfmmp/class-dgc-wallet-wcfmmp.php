...
if (!class_exists('dgc_Wallet_WCFMMP')) {
    ...
    class dgc_Wallet_WCFMMP {
         ...
         * @var string 
         */
        public static $gateway_slug = 'dgc_wallet';
        ...
        public function wcfm_marketplace_settings_fields_withdrawal_charges($withdrawal_charges, $wcfm_withdrawal_options, $withdrawal_charge) {
            ...
            $payment_withdrawal_charges = array("withdrawal_charge_" . self::$gateway_slug => array('label' => __('Wallet Charge', 'dgc-wallet'), 'type' => 'multiinput', 'name' => 'wcfm_withdrawal_options[withdrawal_charge][' . self::$gateway_slug . ']', 'class' => 'withdraw_charge_block withdraw_charge_' . self::$gateway_slug, 'label_class' => 'wcfm_title wcfm_ele wcfm_fill_ele withdraw_charge_block withdraw_charge_' . self::$gateway_slug, 'value' => $withdrawal_charge_wallet, 'custom_attributes' => array('limit' => 1), 'options' => array(
                        "percent" => array('label' => __('Percent Charge(%)', 'dgc-wallet'), 'type' => 'number', 'class' => 'wcfm-text wcfm_ele withdraw_charge_field withdraw_charge_percent withdraw_charge_percent_fixed', 'label_class' => 'wcfm_title wcfm_ele withdraw_charge_field withdraw_charge_percent withdraw_charge_percent_fixed', 'attributes' => array('min' => '0.1', 'step' => '0.1')),
                        "fixed" => array('label' => __('Fixed Charge', 'dgc-wallet'), 'type' => 'number', 'class' => 'wcfm-text wcfm_ele withdraw_charge_field withdraw_charge_fixed withdraw_charge_percent_fixed', 'label_class' => 'wcfm_title wcfm_ele withdraw_charge_field withdraw_charge_fixed withdraw_charge_percent_fixed', 'attributes' => array('min' => '0.1', 'step' => '0.1')),
                        "tax" => array('label' => __('Charge Tax', 'dgc-wallet'), 'type' => 'number', 'class' => 'wcfm-text wcfm_ele', 'label_class' => 'wcfm_title wcfm_ele', 'attributes' => array('min' => '0.1', 'step' => '0.1'), 'hints' => __('Tax for withdrawal charge, calculate in percent.', 'dgc-wallet')),
            )));
