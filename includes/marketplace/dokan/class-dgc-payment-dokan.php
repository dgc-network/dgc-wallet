...
if ( ! class_exists( 'dgc_Payment_Dokan' ) ) {

    class dgc_Payment_Dokan {

        /**
         * The single instance of the class.
         *
         * @var dgc_Payment_Dokan
         * @since 1.1.10
         */
        ...
        public function __construct() {
            ...
            add_action( 'dgc_payment_payment_processed', array( $this, 'dgc_payment_payment_processed' ) );
        ...
        /**
         * Display payment method to vendor
        ...
        /**
         * Process payment commission transfer
         * @param int $order_id
         * @return Void
         * @throws Exception
         */
        public function dgc_payment_payment_processed( $order_id ) {
        ...
        /**
         * Auto credit payment upon approval of dokan withdrawal.
         * @global Object $wpdb
         * @param string $status
         * @param int $user_id
         * @param int $row_id
        ...
        public function dokan_withdraw_status_updated( $status, $user_id, $row_id ) {
            ...
            $payment_transaction = $wpdb->get_row( $wpdb->prepare( "SELECT transactions.transaction_id FROM {$wpdb->base_prefix}dgc_payment_transactions AS transactions INNER JOIN {$wpdb->base_prefix}dgc_payment_transaction_meta AS transaction_meta ON transactions.transaction_id = transaction_meta.transaction_id WHERE transaction_meta.meta_key = %s AND transaction_meta.meta_value = %d", '_dokan_withdrawal_id', $row_id ) );
            if (1 === $status) {
                if ( $payment_transaction && isset( $payment_transaction->transaction_id ) ) {
                    ...
                    $transaction_id = dgc_payment()->payment->credit( $user_id, $resualt->amount, __( 'Withdrawal request #' . $row_id ) );
