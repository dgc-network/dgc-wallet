    ...
    */
    ...
    public function column_default( $item, $column_name ) {
        switch ( $column_name ) {
            ...
            case 'actions':
                return '<p><a href="' . add_query_arg( array( 'page' => 'dgc-wallet-add', 'user_id' => $item['id'] ), admin_url( 'admin.php' ) ) . '" class="button tips payment-manage"></a> <a class="button tips payment-view" href="' . add_query_arg( array( 'page' => 'dgc-wallet-transactions', 'user_id' => $item['id'] ), admin_url( 'admin.php' ) ) . '"></a></p>';
            default:
