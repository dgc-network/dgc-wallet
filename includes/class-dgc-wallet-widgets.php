...
class dgc_Wallet_Topup extends WP_Widget {
    ...
    public function __construct() {
        $widget_ops = array(
            ...
            'description' => __('dgcWallet top-up form for your site.', 'dgc-wallet'),
            'customize_selective_refresh' => true,
        );
        parent::__construct('dgc-wallet-topup', _x('Wallet Top-up', 'Wallet Top-up widget', 'dgc-wallet'), $widget_ops);
    }
    ...
    public function widget($args, $instance) {
        ...
        <form method="post" action="">
            <div class="dgc-wallet-add-amount">
                ...
                ?>
                <input type="number" step="0.01" min="<?php echo $min_amount; ?>" max="<?php echo $max_amount; ?>" name="dgc_wallet_balance_to_add" id="dgc_wallet_balance_to_add" class="dgc-wallet-balance-to-add input-text" placeholder="<?php _e('Enter amount', 'dgc-wallet'); ?>" required="" />
