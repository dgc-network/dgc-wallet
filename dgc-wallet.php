...
if(dgc_wallet_is_woocommerce_active()){
	add_filter('woocommerce_payment_gateways', 'add_dgc_wallet_gateway');
	function add_dgc_wallet_gateway( $gateways ){
		$gateways[] = 'dgc_Wallet_Gateway';
		return $gateways; 
	}

	add_action('plugins_loaded', 'init_dgc_wallet_gateway');
	function init_dgc_wallet_gateway(){
		require dirname( __FILE__ ) . '/includes/class-dgc-wallet-gateway.php';
	}
}
*/
/**
 ...
 */
/*
function dgc_wallet_is_woocommerce_active()
{
